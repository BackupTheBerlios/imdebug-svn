  ...
  case WM_PAINT :
  {
    ...
    if (refreshPending) {
      ...
      if (ret && cw) 
      {
        ...
        imgL = LoadImage(hInstance, MAKEINTRESOURCE(IDB_ARROWLF), IMAGE_BITMAP, 0, 0, LR_DEFAULTCOLOR);
        imgR = LoadImage(hInstance, MAKEINTRESOURCE(IDB_ARROWRT), IMAGE_BITMAP, 0, 0, LR_DEFAULTCOLOR);
        imgU = LoadImage(hInstance, MAKEINTRESOURCE(IDB_ARROWUP), IMAGE_BITMAP, 0, 0, LR_DEFAULTCOLOR);
        imgD = LoadImage(hInstance, MAKEINTRESOURCE(IDB_ARROWDN), IMAGE_BITMAP, 0, 0, LR_DEFAULTCOLOR);
