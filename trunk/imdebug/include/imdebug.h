...
#ifndef IMDBG_EXPORT
#define IMDBG_EXPORT __declspec(dllimport)
...
/*===========================================================================*/
/*                                                                           */
/*  This is it. The one function you need to know about:                     */

IMDBG_EXPORT void CALLBACK imdebug(const char *format, ...);
